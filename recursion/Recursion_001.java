...
public class Recursion_001 {
  ...
  public static void main(String args[]) {
    ...
    print(
        "last index found at : "
            + printLastIndexOfElement(new int[] {2, 8, 2, 9, 11, 2, 15}, 12, 0));
    ...
    printLineWithMessage(
        "find subsequences using String ascii -- three choices for every char Using 3"
            + " recursion.\n");
  ...
  public static StringBuilder printReversedString_v2(
      String string, int count, StringBuilder stringBuilder) {
